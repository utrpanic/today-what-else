...
final class OffGameComponent: Component<OffGameDependency> {
    ...
    fileprivate var player1Name: String { return self.dependency.player1Name }
    fileprivate var player2Name: String { return self.dependency.player2Name }
    fileprivate var scoreStream: ScoreStream { return self.dependency.scoreStream }
}
